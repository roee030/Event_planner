...
//
//
//    private static final String TAG = "event management";
//
//    String eventID;
//
//    TextView eventName;
...
//        productsList.setAdapter(new com.example.roeea.eventplanner.Activities.EventInvitationActivity.ProductsListAdapter(productsList));
//
//        usersList = findViewById(R.id.usersList);
//        usersList.setLayoutManager(new LinearLayoutManager(this));
//        usersList.setAdapter(new com.example.roeea.eventplanner.Activities.EventInvitationActivity.UsersListAdapter(usersList));
//
//
...
//                });
//
//                Toast.makeText(com.example.roeea.eventplanner.Activities.EventInvitationActivity.this, "Event Accepted!", Toast.LENGTH_SHORT).show();
...
//                event.getInvited().remove(userID);
//                fEventRef.setValue(event);
//                Toast.makeText(com.example.roeea.eventplanner.Activities.EventInvitationActivity.this, "Event Declined!", Toast.LENGTH_SHORT).show();
//                Intent intent = new Intent(getBaseContext(), AccountActivity.class);
//                startActivity(intent);
//            }
//        });
